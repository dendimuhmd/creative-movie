...
void main() {
  ...
  group('get Top Rated TvSeriess', () {
    final tTvSeriesList = TvSeriesResponse.fromJson(
            json.decode(readJson('dummy_data/tv_series/top_rated_series.json')))
        .tvSerieslist;
    ...
    test('should return list of tv/on_the_airs when response code is 200 ',
      ...
      when(mockHttpClient.get(
        ...
        headers: anyNamed('headers'),
          ...
          readJson('dummy_data/tv_series/top_rated_series.json'), 200));
      // act
  ...
  group('get tv detail', () {
    ...
    final tTvSeriesDetail = TvSeriesDetailResponse.fromJson(
        json.decode(readJson('dummy_data/tv_series/series_detail.json')));
    ...
    test('should return tv/on_the_air detail when the response code is 200',
      ...
      when(mockHttpClient.get(
        ...
        headers: anyNamed('headers'),
          ...
          readJson('dummy_data/tv_series/series_detail.json'), 200));
      // act
  ...
  group('get tv recommendations', () {
    final tTvSeriesList = TvSeriesResponse.fromJson(json.decode(
            readJson('dummy_data/tv_series/series_recommendations.json')))
        .tvSerieslist;
    final tId = 135647;
  ...
  group('search tv', () {
    final tSearchResult = TvSeriesResponse.fromJson(json.decode(
            readJson('dummy_data/tv_series/search_2good2betrue_series.json')))
        .tvSerieslist;
